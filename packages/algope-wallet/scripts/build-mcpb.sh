...
OUTPUT="$ROOT_DIR/algope.mcpb"

echo "Building AlgoPe desktop extension..."
...
if [ -f "$ROOT_DIR/algope-logo.png" ]; then
  cp "$ROOT_DIR/algope-logo.png" "$BUILD_DIR/algope-logo.png"
fi
