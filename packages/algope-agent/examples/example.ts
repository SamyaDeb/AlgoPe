/**
 * AlgoPe Agent Example
 *
 * This example demonstrates how to use the AlgoPe agent in your code.
 *
 * Prerequisites:
 * 1. Run `algope-agent init` to configure your agent
...
import { AlgoPeAgent } from "../src/index.js";

async function main() {
  console.log("🤖 AlgoPe Agent Example\n");

  // Create the agent (reads config from ~/.algope/agent.json)
