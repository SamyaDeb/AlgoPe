...
async function runTests() {
  ...
  console.log("  AlgoPe Agent - Full Agent Flow Test");
  console.log("=".repeat(60));
  console.log();
  ...
  console.log("  ✅ Config saved to ~/.algope/agent.json");
  console.log();
  ...
  console.log("  Run 'algope-agent status' to see full configuration.");
  console.log();
}
