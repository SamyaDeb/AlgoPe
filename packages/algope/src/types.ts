...
export interface AlgoPeConfig {
  ...
  // Facilitator — who verifies and settles x402 payments.
  //   "auto"        (default) try GoPlausible, fall back to self-settlement
  //   "goplausible" require the remote facilitator (fails fast if unusable)
  //   "local"       in-process facilitator signing with your mnemonic
  //   "self"        relay client-signed txns yourself; no key, client pays fees
