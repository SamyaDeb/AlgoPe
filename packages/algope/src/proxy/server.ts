...
import type { AlgoPeConfig, PaymentEvent, RouteConfig } from "../types.js";
import {
  ALGORAND_TESTNET_CAIP2,
  ALGORAND_MAINNET_CAIP2,
} from "../types.js";
import { resolveFacilitator, type ResolvedFacilitator } from "../facilitator/resolve.js";
...
export async function createProxyServer(
...
): Promise<{ app: Express; facilitator: ResolvedFacilitator }> {
  ...
  // Pick who verifies and settles payments. Defaults to the hosted GoPlausible
  // facilitator (gasless for consumers) and degrades to local settlement if it
  // cannot serve this token/network — see facilitator/resolve.ts.
  ...
  const resourceServer = new x402ResourceServer(facilitator.client as any);
