...
const savedTheme = localStorage.getItem('algope-theme');
if (savedTheme) {
...
if (themeToggle) {
  themeToggle.addEventListener('click', () => {
    ...
    localStorage.setItem('algope-theme', next);
  });
}

// ===== INSTALL TAB SWITCHER =====
const installCommands = {
  npm: 'npm install @algope/agent',
  yarn: 'yarn add @algope/agent',
  pnpm: 'pnpm add @algope/agent'
};
