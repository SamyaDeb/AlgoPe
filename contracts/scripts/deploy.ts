#!/usr/bin/env tsx
/**
 * Deploy AlgoPeRegistry contract to Algorand testnet.
 *
 * Usage:
...
const arc56Path = path.join(__dirname, "../src/out/AlgoPeRegistry.arc56.json");
...
console.log(`\nDeploying AlgoPeRegistry to ${NETWORK}...`);
...
console.log("\n========================================");
console.log("  AlgoPeRegistry deployed successfully!");
console.log("========================================");
console.log(`  App ID:      ${appId}`);
console.log(`  App address: ${appAddress}`);
console.log(`  Network:     ${NETWORK}`);
console.log(`  Action:      ${action}`);
console.log("\n  Save this App ID for your algope config:");
console.log(`  ALGOPE_REGISTRY_APP_ID=${appId}`);
console.log();
